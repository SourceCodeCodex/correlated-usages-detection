...
public class DerivationManager<J extends IJavaElement> implements IDerivationManager<J> {
	...
	private final LinkedBlockingQueue<Pair<Writing<J>, Writing<J>>> writingPairs = new LinkedBlockingQueue<>();
	private final Set<Pair<Writing<J>, Writing<J>>> derived = Collections.synchronizedSet(new HashSet<>());
	...
	public DerivationManager(AWritingBindingResolver<J> writingBindingResolver, JavaEntitySearcher javaEntitySearcher,
