...
public final class ConservingNameSimilarityParameterCoveredTypesResolver
    extends AConservingNameSimilarityCoveredTypesResolver<ILocalVariable> {

  public ConservingNameSimilarityParameterCoveredTypesResolver() {
