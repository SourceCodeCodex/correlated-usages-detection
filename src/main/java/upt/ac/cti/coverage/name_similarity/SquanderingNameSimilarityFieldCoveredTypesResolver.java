...
public final class SquanderingNameSimilarityFieldCoveredTypesResolver
    extends ASquanderingNameSimilarityCoveredTypesResolver<IField> {

  public SquanderingNameSimilarityFieldCoveredTypesResolver() {
