...
import upt.ac.cti.coverage.analysis.flow.insensitive.generators.CPGenerator;
...
public class ParallelCPIterator {
  ...
  private final Set<Pair<ITypeBinding, ITypeBinding>> corelations = new HashSet<>();

  public ParallelCPIterator(CPGenerator generator) {
    pairs.addAll(generator.generate());
  }

  public Set<Pair<ITypeBinding, ITypeBinding>> corelations()
